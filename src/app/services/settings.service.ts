...
export class SettingsService {
 ...
 setUseBasicSelection(b : boolean) {
    this.settings.useBasicSelection = b;
    this.lwdb.putSettings(this.settings)
    console.log('settings.service useBasicSelection was set to: ' + this.settings.useBasicSelection);
